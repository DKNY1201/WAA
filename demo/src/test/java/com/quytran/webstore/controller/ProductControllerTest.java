...
import com.quytran.webstore.config.WebApplicationContextConfig;
...
public class ProductControllerTest {
	...
	public void testGetProductById() throws Exception {
		...
		// Act & Assert
		this.mockMvc.perform(get("/market/product").param("id", "P1234")).andExpect(model().attributeExists("product"))
