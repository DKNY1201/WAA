	...
	<div class="container">
		<div class="row">
			<form:form modelAttribute="order" class="form-horizontal">
				...
				<div
					class="well col-xs-10 col-sm-10 col-md-6 colxs-offset-1 col-sm-offset-1 col-md-offset-3">
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center textdanger"><h4> <strong>$${order.cart.grandTotal}</strong>
										</h4></td>
								</tr>
							</tbody>
						</table>
